...
List<String> inkColors = <String>["#993300", "#3399ff", "#003300", "#9630BF", "#ff3399", "#ffcc66", "#003300", "#494132", "#ff9933", "#3da35a", "#9900cc", "#00ff00","#ff0000","#000066"];
...
List<List<String>> dude_quirks = <List<String>>[<String>["dude", "guy"], <String>["dude", "bro"], <String>["dude", "man"], <String>["dude", "you"], <String>["dude", "friend"], <String>["dude", "asshole"], <String>["dude", "fella"], <String>["dude", "bro"]];
...
List<List<String>> yes_quirks = <List<String>>[<String>["\\byes\\b", "certainly"], <String>["\\byes\\b", "indeed"], <String>["\\byes\\b", "yes"], <String>["\\byes\\b", "yeppers"], <String>["\\byes\\b", "right"], <String>["\\byes\\b", "yeah"], <String>["\\byes\\b", "yep"], <String>["\\byes\\b", "sure"], <String>["\\byes\\b", "okay"], <String>["\\byes\\b", "hell yes"]];
List<List<String>> no_quirks = <List<String>>[<String>["\\bnope\\b|\\bno\\b", "hell no"], <String>["\\bnope\\b|\\bno\\b", "absolutely no"], <String>["\\bnope\\b|\\bno\\b", "no"], <String>["\\bnope\\b|\\bno\\b", "no"], <String>["\\bnope\\b|\\bno\\b", "nope"], <String>["\\bnope\\b|\\bno\\b", "no way"],<String>["\\bnope\\b|\\bno\\b", "nah"]];
List<List<String>> friend_quirks = <List<String>>[<String>["friend", "bro"], <String>["friend", "buddy"], <String>["friend", "pal"], <String>["friend", "friend"], <String>["friend", "compadre"], <String>["friend", "comrade"],<String>["friend", "best friend"],<String>["friend", "homey"]];
