  ...
  void doNarration(Element div, int i) {
      ...
      if(!this.player.fromThisSession(this.session) || this.player.land == null){
          ...
          if(this.player.dead==true){
              ...
              if(this.session.derseScepter != null) this.session.derseScepter.addPrototyping(this.player.object_to_prototype); //assume king can't lose crown for now.
              if(this.session.prospitScepter != null) this.session.prospitScepter.addPrototyping(this.player.object_to_prototype); //assume king can't lose crown for now.
              if(this.session.prospitScepter != null) this.session.prospitScepter.addPrototyping(this.player.object_to_prototype); //assume king can't lose crown for now.
              ...
              if(this.session.derseRing != null){
                  this.session.derseRing.addPrototyping(this.player.object_to_prototype); //assume king can't lose crown for now.
