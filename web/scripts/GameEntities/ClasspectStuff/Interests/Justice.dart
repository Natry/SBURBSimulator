...
class Justice extends InterestCategory {
    ...
    @override
    List<String> handles2 =  <String>["Legislator","Legalist",'Legislacerator','Lawman',"Detective", "Defender", "Laywer", "Loyalist", "Liaison", "Vigilante", "Tracker", "Moralist", "Retribution", "Watchman", "Searcher", "Perception", "Rebel", "Investigator"];
