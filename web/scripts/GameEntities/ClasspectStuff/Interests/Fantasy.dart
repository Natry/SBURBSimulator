...
class Fantasy extends InterestCategory {
    ...
    @override
    List<String> handles2 =<String>["Lich","Believer", "Dragon", "Magician", "Sandman", "Shinigami", "Tengu", "Harpy", "Dwarf", "Vampire", "Lamia", "Roc", "Mermaid", "Siren", "Manticore", "Banshee", "Basilisk", "Boggart","Illusionist"];
