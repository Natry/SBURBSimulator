...
class Athletic extends InterestCategory {
    ...
    @override
    List<String> handles2 =<String>["Swimmer", "Trainer", "Baller", "Handler", "Runner", "Leaper", "Racer", "Vaulter", "Major", "Tracker", "Heavy", "Brawn", "Darter", "Brawler", "Iceskater"];
    ...
    void initializeThemes() {
        ...
        addTheme(new Theme(<String>["Teams","Sports","Balls", "Competition", "Athletics", "Olympians"])
            ...
            ], new RandomReward(), QuestChainFeature.playerIsProtectiveClass), Feature.HIGH)
