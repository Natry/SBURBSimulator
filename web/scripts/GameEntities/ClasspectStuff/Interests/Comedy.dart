...
class Comedy extends InterestCategory {
    ...
    @override
    List<String> handles2 =<String>["LaughMaster","Laugher", "Humorist", "Trickster", "Sellout", "Dummy", "Silly", "Bum", "Huckster", "Raconteur", "Mime", "Leaper", "Vaudevillian", "Baboon", "Boor","Imp"];
